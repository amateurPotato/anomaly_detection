...
#   make demo           run the demo against local Ollama (default)
#   make demo-cloud     run the demo against Anthropic Claude (needs ANTHROPIC_API_KEY)
...
.PHONY: install test test-fast test-llm test-tracker demo demo-cloud check-ollama
